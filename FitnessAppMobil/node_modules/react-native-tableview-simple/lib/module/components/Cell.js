...
const Cell = ({ accessory = false, accessoryColor, accessoryColorDisclosureIndicator, allowFontScaling = true, backgroundColor, cellStyle = 'Basic', cellContentView, cellImageView, cellAccessoryView, contentContainerStyle = {}, detail, detailTextStyle = {}, detailTextProps = {}, disableImageResize = false, highlightActiveOpacity = 0.8, highlightUnderlayColor, image, isDisabled = false, onPress, onPressDetailAccessory, onHighlightRow, onUnHighlightRow, leftDetailColor, rightDetailColor, subtitleColor, subtitleTextStyle = {}, testID, title, titleTextProps = {}, titleTextStyle = {}, titleTextStyleDisabled = {}, titleTextColor, withSafeAreaView = Platform.OS === 'ios'
    ...
    const renderAccessoryDetail = () => {
        if (onPressDetailAccessory) {
            return (<TouchableOpacity style={_styles.accessoryDetail} onPress={onPressDetailAccessory} activeOpacity={0.7} disabled={isDisabled}>
          <Text style={_styles.accessoryDetailText}>i</Text>
        </TouchableOpacity>);
        }
        return (<View style={_styles.accessoryDetail}>
        <Text style={_styles.accessoryDetailText}>i</Text>
      </View>);
    };
    /**
    ...
    const renderAccessoryView = () => {
        switch (accessory) {
            case 'DisclosureIndicator':
                return (<View style={_styles.cellAccessoryView}>
    ...
    const renderImageView = () => {
        ...
        return (<View style={_styles.cellImageView}>
     ...
     */
    const renderCellBasic = () => (<View style={_styles.cellContentView}>
      <Text allowFontScaling={allowFontScaling} numberOfLines={1} style={_styles.cellTitle} {...titleTextProps}>
        {title}
      </Text>
    </View>);
    /**
     ...
     */
    const renderCellRightDetail = () => (<View style={_styles.cellContentView}>
      <Text allowFontScaling={allowFontScaling} numberOfLines={1} style={_styles.cellTitle} {...titleTextProps}>
        {title}
      </Text>
     ...
     * @return {View} View with Text, Text and Accessory
     */
    const renderCellLeftDetail = () => (<View style={_styles.cellContentView}>
      <Text allowFontScaling={allowFontScaling} numberOfLines={1} style={isDisabled
        ? [_styles.cellLeftDetail, _styles.cellTextDisabled]
        : _styles.cellLeftDetail} {...detailTextProps}>
        {detail}
      </Text>
      <Text allowFontScaling={allowFontScaling} numberOfLines={1} style={_styles.cellLeftDetailTitle} {...titleTextProps}>
        {title}
      </Text>
    </View>);
    /**
     ...
     */
    const renderCellSubtitle = () => (<View style={[_styles.cellContentView, _styles.cellContentViewTypeSubtitle]}>
     ...
     */
    const renderCell = () => (<View style={_styles.cell}>
     ...
     * @return {View} Complete View with cell elements
     */
    const renderCellWithSafeAreaView = () => (<SafeAreaView style={_styles.cellSafeAreaContainer}>
